...
def evaluate_and_save_results(classifiers, X_test_samples, y_test, method, n_components, k, n_classifiers, output_file):
    ...
    logging.info(f"Accuracy for method={method}, n_components={n_components}, k={k}, n_classifiers={n_classifiers}: {accuracy:.4f}")
...
def main_forest_knn(dataset_name):
    ...
    k_values = [3, 5, 10, 15]
    n_classifiers_list = [10, 20, 30]   #ensemble sizes
